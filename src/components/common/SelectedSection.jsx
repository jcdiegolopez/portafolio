...
const SelectedSection = ({ selectedSection, currentSectionIndex, isScrolling, sections }) => {
    ...
    <AnimatePresence mode="wait">
      {selectedSection && (
        <motion.div
          ...
          initial={{ opacity: 0, scale: 0.8, y: 50, x: '-50%', width: 288, height: 60, transformOrigin: 'center top' }}
          animate={{ opacity: 1, scale: 1, y: 0, x: '-50%', width: '100vw', height: '100vh', borderRadius: 0, zIndex: 1000 }}
          exit={{
            opacity: 0,
            scale: 0.8,
