    ...
    >
      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto">
        <div className="flex flex-col items-start">
          {/* Grupo 1: Introducción (Subtítulo y Título) */}
          <motion.div
          ...
          >
            ...
            <h1 className="text-5xl sm:text-7xl font-bold text-zinc-100 mb-6">
              Diego López
            </h1>
          </motion.div>

          {/* Grupo 2: Detalles (Roles y Descripción) */}
          <motion.div
            initial={{ opacity: 0, y: 10 }}
            animate={isVisible ? { opacity: 1, y: 0 } : { opacity: 0, y: 10 }}
            transition={{ duration: 1, delay: 0.4 }}
          >
            <div className="h-14 sm:h-16 mb-8">
          ...
          {/* Grupo 3: Acciones (Botones y Enlaces Sociales) */}
          <motion.div
            initial={{ opacity: 0, y: 10 }}
            animate={isVisible ? { opacity: 1, y: 0 } : { opacity: 0, y: 10 }}
              ...
              >
                ...
                >
                  <path
                    ...
                    strokeLinejoin="round"
                    strokeWidth={2}
                    d="M9 17V7m0 10l-3-3m3 3l3-3m-6-7h12"
                  />
                </svg>
                Ver Proyectos
              </a>
